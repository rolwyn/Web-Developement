...
1. Clone the Repo using ```git clone``` command followed by the HTTPS link in terminal.
    ...
    Example: ```https://github.com/neu-mis-info6150-fall2021/assignment-8-rolwynquadras.git```

2. Do ```npm install``` to install all the development dependencies
3. Go to terminal and run ```npm run start```
4. Browser will automatically open on the default port
